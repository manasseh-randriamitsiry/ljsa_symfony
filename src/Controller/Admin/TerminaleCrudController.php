...
class TerminaleCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return Terminale::class;
    }
    ...
    #[Route('/pdf_terminale', name: 'app_pdf_terminale')]
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield NumberField::new('PHYLO')->setCssClass("w-50");
        yield NumberField::new('trimestre','TRI')->setCssClass("w-50");
...

    {
        return $actions
            ...
            ->add(Crud::PAGE_INDEX, Action::new("generate_pdf",'generer pdf' ,'fas fa-save')->linkToRoute('app_pdf_terminale'));
    }
    public function configureCrud(Crud $crud): Crud
    {
        return $crud->setEntityLabelInPlural("Notes Terminale")
            ->setEntityLabelInSingular("Notes Terminale");
    }
